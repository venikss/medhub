...
urlpatterns = [
    ...
    # recollect must come before <uuid:pk>/ to avoid URL conflict
    ...
    # Critical values — both notify and acknowledge use `critical/` prefix (spec-aligned)
    # List endpoint kept at critical-values/ to avoid conflict with result_id routes
