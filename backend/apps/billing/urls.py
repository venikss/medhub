...
urlpatterns = [
    ...
    path("claims/<uuid:pk>/status/", views.ClaimStatusView.as_view(), name="claim-status"),
    path("claims/<uuid:pk>/submit/", views.ClaimSubmitView.as_view(), name="claim-submit"),
    path("claims/<uuid:pk>/resubmit/", views.ClaimResubmitView.as_view(), name="claim-resubmit"),

    path("payments/", views.PaymentListCreateView.as_view(), name="payment-list-create"),
    path("payments/<uuid:pk>/void/", views.PaymentVoidView.as_view(), name="payment-void"),
